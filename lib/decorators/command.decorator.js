            ...
            var _loop_1 = function (i) {
                ...
                if (!(param === null || param === void 0 ? void 0 : param.customType)) {
                    ...
                    try {
                        ...
                        throw new cmderror_1.CmdError("Failed to parse value for parameter: " + paramName, { param: param, commandData: commandData });
                    }
...
function parseToType(value, expectedType) {
    ...
    if (isNaN(result) || invalidValuesList.indexOf(result) >= 1) {
        throw new cmderror_1.CmdError("Not allowed value: " + value, { value: value, expectedType: expectedType.name });
    }
    return result;
}
